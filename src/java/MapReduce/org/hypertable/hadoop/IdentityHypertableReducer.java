 ...
 *
 */
public abstract class IdentityHypertableReducer
extends HypertableReducer<Writable, Writable, Writable> {
  private static final Log log = LogFactory.getLog(IdentityHypertableReducer.class);

  @Override
  public void reduce(Writable key, Iterable<Writable> values, Context context)
      throws IOException, InterruptedException {
    for(Writable cell : values) {
