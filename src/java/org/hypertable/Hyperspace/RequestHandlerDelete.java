...
public class RequestHandlerDelete extends ApplicationHandler {

    static final Logger log = Logger.getLogger("org.hypertable.Hyperspace");

    public RequestHandlerDelete(Comm comm, Hyperspace hyperspace, Event event) {
	super(event);
	mComm = comm;
	...
	try {
	    ...
	    mHyperspace.Delete(cb, fileName);
