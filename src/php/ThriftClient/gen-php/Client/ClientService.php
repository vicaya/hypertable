      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem191 = null;
              $elem191 = new Hypertable_ThriftGen_Cell();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem226 = null;
              $elem226 = new Hypertable_ThriftGen_TableSplit();
