...
namespace Hyperspace {
  ...
  public:
    RequestHandlerAttrDel(Comm *comm, Master *master, uint64_t sessionId, EventPtr &eventPtr) : ApplicationHandler(eventPtr), m_comm(comm), m_master(master), m_session_id(sessionId) {
      return;
    }
