...
namespace Hyperspace {
  ...
  public:
    RequestHandlerStatus(Comm *comm, Master *master, uint64_t session_id, EventPtr &event_ptr) : ApplicationHandler(event_ptr), m_comm(comm), m_master(master), m_session_id(session_id) {
      return;
    }
