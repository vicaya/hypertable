...
uint32_t HqlResult::read(facebook::thrift::protocol::TProtocol* iprot) {
...
uint32_t HqlResult::write(facebook::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("HqlResult");
  if (this->__isset.results) {
    xfer += oprot->writeFieldBegin("results", facebook::thrift::protocol::T_LIST, 1);
    {
      xfer += oprot->writeListBegin(facebook::thrift::protocol::T_STRING, this->results.size());
  ...
  if (this->__isset.scanner) {
    xfer += oprot->writeFieldBegin("scanner", facebook::thrift::protocol::T_I64, 3);
    xfer += oprot->writeI64(this->scanner);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.mutator) {
    xfer += oprot->writeFieldBegin("mutator", facebook::thrift::protocol::T_I64, 4);
