...
namespace hypertable {
  ...
  public:
    EventHandlerServerLeft(MasterPtr &masterPtr, std::string serverIdStr, EventPtr &eventPtr) : ApplicationHandler(eventPtr), mMasterPtr(masterPtr), mServerIdStr(serverIdStr) {
      return;
    }
