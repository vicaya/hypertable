...
namespace hypertable {
  ...
  public:
    EventHandlerServerLeft(MasterPtr &masterPtr, std::string serverIdStr, EventPtr &eventPtr) : ApplicationHandler(eventPtr), m_master_ptr(masterPtr), m_server_id_str(serverIdStr) {
      return;
    }
