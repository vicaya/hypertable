...
namespace Hypertable {
  ...
  public:
    EventHandlerServerLeft(MasterPtr &masterPtr, std::string location, EventPtr &eventPtr) : ApplicationHandler(eventPtr), m_master_ptr(masterPtr), m_location(location) {
      return;
    }
