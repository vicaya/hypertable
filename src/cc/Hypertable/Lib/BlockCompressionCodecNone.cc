 ...
 *
 */
BlockCompressionCodecNone::BlockCompressionCodecNone(std::string args) {
}
 ...
 * 
 */
int BlockCompressionCodecNone::deflate(const DynamicBuffer &input, DynamicBuffer &output, BlockCompressionHeader *header, size_t reserve) {
  output.clear();
 ...
 * 
 */
int BlockCompressionCodecNone::inflate(const DynamicBuffer &input, DynamicBuffer &output, BlockCompressionHeader *header) {
  int error;
