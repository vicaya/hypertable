 ...
 *
 * Description: Memory pool used for the CellCache <key, value> pairs and
 * CellMap
 *
 * This file is part of Hypertable.
 *
 * Hypertable is free software; you can redistribute it and/or modify it under
 * the terms of the GNU General Public License as published by the Free
 * Software Foundation; either version 2 of the License, or any later version.
 *
 * Hypertable is distributed in the hope that it will be useful, but WITHOUT
  ...
  public:
    CellCachePool(size_t sz = CCP_BUF_SIZE)
      ...
      void deallocate(void *ptr, size_t sz= 0) {
        /* Unimplemented. No need here. We free all the memory when the
         * CellCache is destructing. */
      }

      uint64_t memory_used() { return m_total_allocated; }
      ...
      void dump_stat() {
        ...
        std::cout << "Current Pool Size : "
                  ...
                  <<"; Free size : " << m_tail_ptr - m_head_ptr << std::endl;
      }
