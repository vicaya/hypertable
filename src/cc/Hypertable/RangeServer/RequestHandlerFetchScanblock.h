...
namespace Hypertable {
  ...
  public:
    RequestHandlerFetchScanblock(Comm *comm, RangeServer *rs, EventPtr &event_ptr) : ApplicationHandler(event_ptr), m_comm(comm), m_range_server(rs) {
      return;
    }
...
#endif // HYPERTABLE_REQUESTHANDLERFETCHSCANBLOCK_H
