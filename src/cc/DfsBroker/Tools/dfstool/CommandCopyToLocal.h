...
#ifndef HYPERTABLE_COMMANDCOPYTOLOCAL_H
#define HYPERTABLE_COMMANDCOPYTOLOCAL_H
...
namespace hypertable {
  ...
  public:
    CommandCopyToLocal(DfsBrokerClient *client) : mClient(client) { return; }
...
#endif // HYPERTABLE_COMMANDCOPYTOLOCAL_H
