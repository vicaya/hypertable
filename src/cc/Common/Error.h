...
namespace Hypertable {
  namespace Error {
    enum Code {
      ...
      HYPERSPACE_STATEDB_SESSION_EXISTS            = 0x00030010,
      HYPERSPACE_STATEDB_SESSION_NOT_EXISTS        = 0x00030021,
      HYPERSPACE_STATEDB_SESSION_ATTR_NOT_FOUND    = 0x00030021,
      HYPERSPACE_STATEDB_HANDLE_EXISTS             = 0x00030023,
      HYPERSPACE_STATEDB_HANDLE_NOT_EXISTS         = 0x00030024,
      HYPERSPACE_STATEDB_HANDLE_ATTR_NOT_FOUND     = 0x00030021,
      HYPERSPACE_STATEDB_NODE_EXISTS               = 0x00030023,
      HYPERSPACE_STATEDB_NODE_NOT_EXISTS           = 0x00030024,
      HYPERSPACE_STATEDB_NODE_ATTR_NOT_FOUND       = 0x00030025,
