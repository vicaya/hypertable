...
namespace Hypertable {
  namespace Error {
    enum Code {
      ...
      HYPERSPACE_STATEDB_ERROR                     = 0x00030019,
      HYPERSPACE_STATEDB_DEADLOCK                  = 0x0003001A,
      HYPERSPACE_STATEDB_BAD_KEY                   = 0x0003001B,
      HYPERSPACE_STATEDB_BAD_VALUE                 = 0x0003001C,
      HYPERSPACE_STATEDB_ALREADY_DELETED           = 0x0003001D,
      HYPERSPACE_STATEDB_EVENT_EXISTS              = 0x0003001E,
      HYPERSPACE_STATEDB_EVENT_NOT_EXISTS          = 0x0003001F,
      HYPERSPACE_STATEDB_EVENT_ATTR_NOT_FOUND      = 0x00030020,
      HYPERSPACE_STATEDB_SESSION_EXISTS            = 0x00030021,
      HYPERSPACE_STATEDB_SESSION_NOT_EXISTS        = 0x00030022,
      HYPERSPACE_STATEDB_SESSION_ATTR_NOT_FOUND    = 0x00030023,
      HYPERSPACE_STATEDB_HANDLE_EXISTS             = 0x00030024,
      HYPERSPACE_STATEDB_HANDLE_NOT_EXISTS         = 0x00030025,
      HYPERSPACE_STATEDB_HANDLE_ATTR_NOT_FOUND     = 0x00030026,
      HYPERSPACE_STATEDB_NODE_EXISTS               = 0x00030027,
      HYPERSPACE_STATEDB_NODE_NOT_EXISTS           = 0x00030028,
      HYPERSPACE_STATEDB_NODE_ATTR_NOT_FOUND       = 0x00030029,
