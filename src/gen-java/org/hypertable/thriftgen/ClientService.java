            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<Cell>(_list20.size);
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.cells = new ArrayList<Cell>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  Cell _elem26;
                  _elem26 = new Cell();
                  _elem26.read(iprot);
                  this.cells.add(_elem26);
                }
                iprot.readListEnd();
              }
            } else { 
